...
const CACHE_NAME = "tinder-message-v10";
...
self.addEventListener("install", (event) => {
  ...
  /* No skipWaiting() here on purpose. The new worker waits until the
     app's "Update" button asks it to take over, which is what makes a
     visible update notice possible instead of a silent reload. */
});
